            ...
            <div className="container flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
                ...
                <div className="flex flex-col space-y-12 md:w-1/2">
                    ...
                    <p className="max-w-md text-center text-darkGrayishBlue md:text-left">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus nam accusantium quis ducimus suscipit dolorem.
                    </p>
                ...
                <div className="flex flex-col space-y-8 md:w-1/2">
                    ...
                    <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                        ...
                        <div>
                            <h3 className="hidden text-lg font-bold md:block">Track company-wide progress</h3>
